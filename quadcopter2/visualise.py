...
class Quadrotor:
    ...
    def __init__(
        self, x=0, y=0, z=0, roll=0, pitch=0, yaw=0, reward=0, title=None, filepath=None, size=2.0
    ):
    ...
    def plot(self, title, filepath):
        ...
        # plot frame
        self.ax.plot([p1_t[0], p2_t[0]], [p1_t[1], p2_t[1]], [p1_t[2], p2_t[2]], "r-", zdir="z")

        self.ax.plot([p3_t[0], p4_t[0]], [p3_t[1], p4_t[1]], [p3_t[2], p4_t[2]], "r-", zdir="z")
...
def get_input_args():
    ...
    parser.add_argument(
        "num_episodes", nargs="?", type=int, default=1, help="Number of episodes to render"
    )
    ...
    parser.add_argument(
        ...
        dest="save",
        action="store_true",
        help="Write animation to disk instead of displaying",
    )
