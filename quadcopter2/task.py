...
class Task:
    ...
    def __init__(
        ...
        # Goal
        self.target_pos = target_pos if target_pos is not None else np.array([0.0, 0.0, 0.0])
    ...
    def get_reward(self):
        ...
        dist_from_target_squared = dist_from_target * dist_from_target
        penalty = 0.004 * dist_from_target_squared
